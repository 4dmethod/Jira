//%attributes = {}
  ...
  // 
  // Note:
  // https://developer.atlassian.com/cloud/jira/platform/rest/v3/#api-rest-api-3-myself-get
  //  
  // History:
...
If (JIRA_Init .success)
	...
	$lStatus:=HTTP Get:C1157(JIRA_Init .server+"/rest/api/3/myself";$oResult;$atHeaderNames;$atHeaderValues)
